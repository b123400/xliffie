...
- (void)windowDidLoad {
    ...
    [str addAttributes:@{NSLinkAttributeName: [NSURL URLWithString:@"https://b123400.net/xliffie/glossary"]} range:[baseStr rangeOfString:NSLocalizedString(@"click here", @"link replacement")]];
